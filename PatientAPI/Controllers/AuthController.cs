...
public class AuthController(
    PatientAPI.Services.PatientRegistrationService registrationService
    ) : ControllerBase
{
    private readonly PatientAPI.Services.PatientRegistrationService _registrationService = registrationService;
