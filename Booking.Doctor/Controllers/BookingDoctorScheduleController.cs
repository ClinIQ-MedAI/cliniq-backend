...
public class BookingDoctorScheduleController : ControllerBase
{
    private readonly IBookingDoctorScheduleService _scheduleService;

    public BookingDoctorScheduleController(IBookingDoctorScheduleService scheduleService)
    {
