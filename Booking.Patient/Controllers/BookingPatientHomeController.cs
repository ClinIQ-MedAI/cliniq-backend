...
[ApiController]
[Route("patient/home")]
public class BookingPatientHomeController : ControllerBase
{
    private readonly IBookingPatientHomeService _homeService;

    public BookingPatientHomeController(IBookingPatientHomeService homeService)
    {
