...
public class DoctorUserService(
    ...
    INotificationService notificationService) : IDoctorUserService
{
    ...
    public async Task<Result<DoctorProfileUpdateRequestResponse>> SubmitUpdateRequestAsync(string userId, SubmitDoctorUpdateRequest request, CancellationToken cancellationToken)
    {
